  ...
  const myChart_1= new Chart(ctx_classe, {
        ...
        data: {
              ...
              datasets:[{
                ...
                borderColor:  'black',
                borderWidth: 1,
                pointHoverBackgroundColor : '#f1c50e'
...
//Fonctions de récupération des données
  async function getData_probabilite(){
    ...
    var url ='https://raw.githubusercontent.com/micbuffa/stageAyaMachineLearningGuitare/master/src/Test/'+music_file+'/Probabilite_classe_predictions.csv';
  ...
  async function getData_classe(){
    ...
    var url ='https://raw.githubusercontent.com/micbuffa/stageAyaMachineLearningGuitare/master/src/Test/'+music_file+'/Classes_predictions.csv';
  ...
  async function getData_ema(){
    ...
    var url ='https://raw.githubusercontent.com/micbuffa/stageAyaMachineLearningGuitare/master/src/Test/'+music_file+'/EMA_predictions.csv';
...
var url = 'https://raw.githubusercontent.com/micbuffa/stageAyaMachineLearningGuitare/master/src/Test/'+music_file+'/'+music_file+'.wav'
wavesurfer.load(url);
